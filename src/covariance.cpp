...
namespace erl::covariance {
    ...
    bool
    Covariance::operator==(const erl::covariance::Covariance &other) const {
    ...
    bool
    Covariance::Write(const std::string &filename) const {
    ...
    static const std::string kFileHeader = "# erl::covariance::Covariance";

    bool
    Covariance::Write(std::ostream &s) const {
    ...
    bool
    Covariance::Read(const std::string &filename) {
