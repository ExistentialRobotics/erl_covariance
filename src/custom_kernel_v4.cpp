...
namespace erl::covariance {
    std::pair<long, long>
    CustomKernelV4::ComputeKtrain(const Eigen::Ref<const Eigen::MatrixXd> &mat_x, const long num_samples, Eigen::MatrixXd &k_mat) const {
    ...
    std::pair<long, long>
    CustomKernelV4::ComputeKtrainWithGradient(const Eigen::Ref<const Eigen::MatrixXd> &, long, Eigen::VectorXl &, Eigen::MatrixXd &) const {
