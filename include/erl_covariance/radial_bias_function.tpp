...
namespace erl::covariance {
    ...
    template<typename Dtype, int Dim>
    std::pair<long, long>
    RadialBiasFunction<Dtype, Dim>::ComputeKtrain(const Eigen::Ref<const MatrixX> &mat_x, const long num_samples, MatrixX &mat_k, MatrixX & /*mat_alpha*/) {
    ...
    template<typename Dtype, int Dim>
    std::pair<long, long>
    RadialBiasFunction<Dtype, Dim>::ComputeKtrain(const Eigen::Ref<const MatrixX> &mat_x, const long num_samples, MatrixX &mat_k) {
        MatrixX mat_alpha;
