...
namespace erl::covariance {
    ...
    public:
        ...
        struct Setting : public common::Yamlable<Setting> {
            ...
            double scale_mix = 1.;    // used by RationalQuadratic, decreasing this value
                                      // allows more local variations, inf --> Gaussian kernel
    ...
    public:
        ...
        ComputeKtrain(const Eigen::Ref<const Eigen::MatrixXd> &mat_x) const = 0;

        [[nodiscard]] virtual Eigen::MatrixXd
         ComputeKtrain(const Eigen::Ref<const Eigen::MatrixXd> &mat_x, const Eigen::Ref<const Eigen::VectorXd> &vec_sigma_y) const = 0;

        [[nodiscard]] virtual Eigen::MatrixXd
        ComputeKtest(const Eigen::Ref<const Eigen::MatrixXd> &mat_x1, const Eigen::Ref<const Eigen::MatrixXd> &mat_x2) const = 0;
