    ...
    py_covariance.def_property_readonly("setting", &Covariance::GetSetting)
        .def(
            ...
            [](const Covariance &self, const Eigen::Ref<const Eigen::MatrixXd> &mat_x, const long num_samples) -> Eigen::MatrixXd {
                ...
                (void) self.ComputeKtrain(mat_x, num_samples, k_mat);
                return k_mat;
            },
            py::arg("mat_x"),
            py::arg("num_samples"))
        .def(
            ...
            [](const Covariance &self,
               ...
               const long num_samples) -> Eigen::MatrixXd {
                const long n = mat_x.cols();
                if (n == 0) { return {}; }
                const auto [rows, cols] = Covariance::GetMinimumKtrainSize(n, 0, 0);
                Eigen::MatrixXd k_mat(rows, cols);
                (void) self.ComputeKtrain(mat_x, vec_var_y, num_samples, k_mat);
                return k_mat;
            },
            py::arg("mat_x"),
            py::arg("vec_var_y"),
        ...
        .def(
            ...
            [](const Covariance &self, const Eigen::Ref<const Eigen::MatrixXd> &mat_x, const long num_samples, Eigen::VectorXl vec_grad_flags)
                -> Eigen::MatrixXd {
                const long n = mat_x.cols();
                if (n == 0) { return {}; }
                ...
                Eigen::MatrixXd k_mat(rows, cols);
                (void) self.ComputeKtrainWithGradient(mat_x, num_samples, vec_grad_flags, k_mat);
                return k_mat;
            },
            py::arg("mat_x"),
            py::arg("num_samples"),
        ...
        .def(
            ...
            [](const Covariance &self,
               ...
               const Eigen::Ref<const Eigen::VectorXd> &vec_var_y,
               const Eigen::Ref<const Eigen::VectorXd> &vec_var_grad) -> Eigen::MatrixXd {
                const long n = mat_x.cols();
                if (n == 0) { return {}; }
                const long dim = mat_x.rows();
                const long n_grad = vec_grad_flags.cast<long>().sum();
                const auto [rows, cols] = Covariance::GetMinimumKtrainSize(n, n_grad, dim);
                Eigen::MatrixXd k_mat(rows, cols);
                (void) self.ComputeKtrainWithGradient(mat_x, num_samples, vec_grad_flags, vec_var_x, vec_var_y, vec_var_grad, k_mat);
                return k_mat;
            },
            py::arg("mat_x"),
            py::arg("num_samples"),
        ...
        .def(
            ...
            [](const Covariance &self,
               ...
               const long num_samples2) -> Eigen::MatrixXd {
                ...
                Eigen::MatrixXd k_mat(rows, cols);
                (void) self.ComputeKtestWithGradient(mat_x1, num_samples1, vec_grad1_flags, mat_x2, num_samples2, k_mat);
                return k_mat;
            },
            py::arg("mat_x1"),
            py::arg("num_samples1"),
